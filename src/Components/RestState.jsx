  ...
  <div className="container bg-gradient-to-r from-custom-blue to-custom-pink h-screen w-screen relative p-0 m-0">
    <Header/>
      ...
      {saidVikram && <audio src={greet} autoPlay onEnded={()=>{ navigate('/langpage'); }} ></audio>}
        ...
        {!saidVikram && <button className='bg-white rounded-3xl w-[70%] h-16  shadow-md shadow-black' onClick={()=>setSaidVikram(1)}><h1 className='text-3xl font-bold bg-gradient-to-r from-custom-blue to-custom-pink bg-clip-text text-transparent'>Hi Vikram</h1></button>}
      </div>
